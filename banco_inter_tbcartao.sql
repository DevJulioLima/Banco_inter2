...
CREATE TABLE `tbcartao` (
  `CREDITO` float(8,2) unsigned NOT NULL,
  `FATURA` float(8,2) unsigned NOT NULL,
  `NUMERO_DO_CARTAO` varchar(16) NOT NULL,
  `CVV` int(3) unsigned zerofill NOT NULL,
  `VALIDADE` date NOT NULL,
  `BANDEIRA` bit(1) NOT NULL,
  PRIMARY KEY (`NUMERO_DO_CARTAO`),
  UNIQUE KEY `NUMERO_DO_CARTAO_UNIQUE` (`NUMERO_DO_CARTAO`)
